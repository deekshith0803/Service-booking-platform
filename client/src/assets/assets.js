...
import main_service from "./main_car.png"
...
export const providerMenuLinks = [
    { name: "Dashboard", path: "/provider", icon: dashboardIcon, coloredIcon: dashboardIconColored },
    { name: "Add service", path: "/provider/add-service", icon: addIcon, coloredIcon: addIconColored },
    { name: "Manage service", path: "/provider/manage-service", icon: serviceIcon, coloredIcon: serviceIconColored },
    { name: "Manage Bookings", path: "/provider/manage-bookings", icon: listIcon, coloredIcon: listIconColored },
]
...
export const dummyMyBookingsData = [
    {
        ...
        "provider": "6847f7cab3d8daecdb517095",
