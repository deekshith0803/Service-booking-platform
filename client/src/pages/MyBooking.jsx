    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-40 mt-10 text-sm">
      ...
      <div>
        {booking.map((booking, index) => (
          <div
            key={booking._id}
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12"
          >
            {/* service image + info */}
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-2">
                ...
                <p
                  className={`px-3 py-1 rounded-full ${booking.status === "confirmed" ? "bg-green-400/15 text-green--400" : "bg-red-400/15 text-red-600"}`}
                >
                  {booking.status}
                </p>
              </div>
